...
class App extends Component {
  ...
  render() {
    const {score, imgUrl, time, isTrue, category} = this.state
          ...
          <div className="content">
            {!isTrue && (
              <div className="first-div">
                    ...
                    <li key={eachTab.tabId}>
                      <button
                        ...
                        className={`tab-button ${
                          eachTab.tabId === category ? 'highlight-text' : ''
                        }`}
                ...
                <ul className="thumbnail-images">
                  {thumbnailsList.map(eachObj => (
                    <li key={eachObj.id}>
                      <button
                        type="button"
                        className="image-button"
                        onClick={() => this.onImageClick(eachObj.thumbnailUrl)}
                      >
                        <img
            ...
            {isTrue && (
              <div className="second-div">
                ...
                <p className="main-heding">YOUR SCORE</p>
